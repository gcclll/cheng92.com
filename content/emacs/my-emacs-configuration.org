#+TITLE: My Emacs Configuration[已废弃]
#+DATE: <2019-08-27 14:20:16>
#+TAGS[]: emacs
#+CATEGORIES[]: emacs
#+LANGUAGE: zh-cn
...
| ~SPC v o~ | ~ivy-pop-view~                                |
| ~SPC v p~ | ~ivy-push-view~                               |
| ~SPC a l~ | leetcode                                      |
...
** packages
*** [[https://github.com/flexibeast/ebuku][ebuku]], browser bookmarks management

install buku: https://github.com/jarun/buku
